...
def generate_multires_net(gen_conf, train_conf) :
...
def __generate_multires_net(
    ...
    if dimension == 2:
        deconv2 = Conv3D(int(64 / downsize_factor), kernel_size=kernel_size)(deconv2)
        deconv3 = Conv3D(int(64 / downsize_factor), kernel_size=kernel_size)(deconv3)
    elif dimension == 3:
        deconv2 = Conv3D(int(64 / downsize_factor), kernel_size=kernel_size)(deconv2)
        deconv3 = Conv3D(int(64 / downsize_factor), kernel_size=kernel_size)(deconv3)
    else:
