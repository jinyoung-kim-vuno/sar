...
# Guerrero et al., NeuroImage-Clinical18, "White matter hyperintensity and stroke lesion segmentation and
# differentiation using convolutional neural networks"
